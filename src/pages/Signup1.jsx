    ...
    // -------------------------- Hàm ------------------------   
        //------------------------VERIFY ACCOUNT-------------------------
            ...
            const handleSendVerifyCode = async (e) => {
                try {
                    //TODO: Gọi API gửi mã xác thực vào email ở đây, nhớ dùng formData.email nhé
        ...
        const handleVerifyEmailSignUp = async (e) => {
            try {
                //TODO: Gọi API verify email ở đây, nhớ dùng formData.email nhé
        ...
        const handleVerifyTenHienThiSignup = async (e) => {
            try {
                //TODO: Gọi API verify tên hiển thị ở đây, nhớ dùng formData.tenHienThi nhé
        ...
        const handleVerifyUsernameSignup = async (e) => {
            try {
                //TODO: Gọi API verify username ở đây, nhớ dùng formData.username nhé
        ...
        const handleVerifyPasswordSignup = async (e) => {
            try {
                //TODO: Gọi API verify password ở đây, nhớ dùng formData.password nhé
        ...
        const handleFinalSignup = async (e) => {
            ...
            try {
                ...
                if (isAllValid) {
                    try {
                        //TODO: Gọi API signup ở đây, nhớ dùng formData.email, formData.tenHienThi, formData.username và formData.password nhé
