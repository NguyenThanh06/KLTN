    ...
    const handleVerifyProtectionChoices = async () => {
        ...
        if (!isAllValid) {
            ...
            try {
                ...
                /*
                * Kiểm tra xong tạo post luôn hế
                ...
                *     applyToAll, //Là áp dụng chung bảo vệ cho tất cả ảnh
                *     globalProtectionSettings, //Thông số bảo vệ áp dụng chung khi applyToAll = true
                *     protectionPayload, //Thông số bảo vệ riêng lẻ từng ảnh, chia ra theo id ảnh, khi applyToAll = false. 
                *               Cái cấu trúc protectionPayload hn như dưới ni (Thành coi ok thì xóa đi):
                *               imageProtectionSettings = {
                                    "file-id-abc": {
                                        noiseLevel: 10,
                                        colorCoverage: 20,
                                ...
                                Àaaa bn quên cái ni, cái độ phủ màu ơ tề (colorCoverage), là bn nói hn phủ lên 1 lớp blending mode là Soft COlor với opacity từ mấy % tới mấy % đúng k? Thì cái colorCoverage ni vd hn là "5" đi, thì độ phủ màu là 5%->15% (5+10), còn vd hn là "20" thì thành 20%->30% (20+10)
                * });
                */
               
    
                //Thành đổi cái ni qua id post ms tạo
                const createdPostID = 123;
                addHelperError({
                    id: Date.now(),
